...
const Banner = () => {
    return (
        <div className="relative -z-40 mt-16 bg-cover bg-center flex flex-col gap-4 justify-center text-center" style={{backgroundImage:`url(${background})`}}>
            ...
            <p className='text-xl font-semibold text-white my-8'>Learn and Master Basic Programming, Data Structures, Algorithm, OOP, Database and solve 500+ coding problems to become an exceptionally well world-class Programmer.</p>
